...
const SalahIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth={1.5} width={18} height={16} color={"currentColor"} fill={"none"} {...props}>
